...
server.registerTool(
  "generate_sound",
  {
    ...
    description: [
      ...
      "",
      "You cannot hear the result, so prefer count=3..5 to give the user a spread to choose from, then report the file paths.",
    ...
    inputSchema: {
      ...
      play: z
        .boolean()
        .optional()
        .describe("Play the sounds on this machine after writing them. Default false."),
      embed_audio: z
        .boolean()
        .optional()
        .describe("Return the audio inline as well as writing files. Default false."),
    },
  },
  async (args) => {
...
server.registerTool(
  "mutate_sound",
  {
    ...
    inputSchema: {
      ...
      embed_audio: z.boolean().optional(),
    },
  },
  async (args) => {
...
server.registerTool(
  "play_sound",
  {
    ...
    description:
      "Play a .wav file through this machine's speakers (afplay/aplay/powershell). " +
